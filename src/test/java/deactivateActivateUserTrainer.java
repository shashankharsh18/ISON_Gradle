...
public class deactivateActivateUserTrainer {
	...
	public void testDeactivateActivateUser() throws Exception {
		...
		driver.findElement(By.id("edit-search-user-text")).sendKeys("ISBL02998");
		Thread.sleep(5000);
		...
		driver.findElement(By.xpath("//input[@id='edit-submit']")).sendKeys(Keys.ENTER);  //Click on Deactivate Button
		Thread.sleep(30000);
