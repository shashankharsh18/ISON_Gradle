...
public class TrainingModuleTrainer {	
	...
	public void IsonLogin() throws InterruptedException
	{
		...
		driver.findElement(By.id("edit-label-0-value")).sendKeys("Trainer TRAINING" +date);
		...
		driver.findElement(By.id("edit-name-0-value")).sendKeys("Trainer Assessment" +date1);
		Thread.sleep(7000);
		...
		driver.findElement(By.id("edit-search-user-text")).sendKeys("Trainer TRAINING" +date);
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("(//input[@type='search'])[1]")).sendKeys("Trainer TRAINING" +date);
		Thread.sleep(3000);
