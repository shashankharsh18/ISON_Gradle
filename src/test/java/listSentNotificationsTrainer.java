...
public class listSentNotificationsTrainer {
	...
	public void ListSentNotifications() throws Exception {
		...
		//ListSent Notifications
		driver.findElement(By.xpath("//a[@title='List Of Sent Notifications']")).click();
		System.out.println("Clicked On List Of Sent Notifications");
		Thread.sleep(8000);
