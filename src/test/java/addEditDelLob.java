...
public class addEditDelLob {
	...
	@Test
	public void testAddEditDelLob() throws Exception {
		...
		driver.findElement(By.linkText("Line Of Business")).click();  
		Thread.sleep(2000);

		//Add LOB
		System.out.println("Started to Add LOB !!");
		driver.findElement(By.linkText("Add")).click();
		Thread.sleep(5000);

		driver.findElement(By.name("process_name")).sendKeys("ViLOB");
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//textarea[@data-drupal-selector='edit-description']")).sendKeys("ViLOBOne");
		Thread.sleep(4000);
		...
		if (var1==true)
		{
			driver.findElement(By.xpath("//input[@type='search']")).sendKeys("ViLOB");
		}
		Thread.sleep(8000);
		...
		driver.findElement(By.name("description")).sendKeys("ViLOBTwo");
