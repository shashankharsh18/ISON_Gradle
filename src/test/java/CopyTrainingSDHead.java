...
public class CopyTrainingSDHead {
	...
	public void SignIn() throws InterruptedException
	{
		...
		driver.findElement(By.id("edit-search-user-text")).sendKeys("SDHead TRAINING");
		Thread.sleep(3000);
		...
		/*	driver.findElement(By.linkText("Use Existing")).click();
		Thread.sleep(5000);

		driver.findElement(By.xpath("(//input[@type='search'])[2]")).sendKeys("ClassRoom Assessment April 1st");
		Thread.sleep(5000);
