...
public class CertificateSDHead {
	...
	public void GetCertificate() throws Exception {
		...
		/*driver.navigate().to("https://bi-3.axxonet.com/isonlms/certificates-details");
		Thread.sleep(5000);
	...
	/*	driver.navigate().to("https://lmstraining.isonxperiences.com/certificates-details");
		...
		driver.findElement(By.xpath("//input[@type='search']")).sendKeys("classRoom Training April 16th");
		Thread.sleep(4000);
