...
public class TrainingModule {	
	...
	public void IsonLogin() throws InterruptedException
	{
		...
		driver.findElement(By.id("edit-name-0-value")).sendKeys("SGA Assessment" +date1);
		Thread.sleep(7000);
		...
		User2.selectByVisibleText("Pradeepa ISBL01905 (ISBL01905)");
		Thread.sleep(2000);

		Select User3 = new Select(driver.findElement(By.id("Array-available")));
		User3.selectByVisibleText("Santhosh KV (ISBL02392)");
		Thread.sleep(2000); */
		...
		driver.findElement(By.id("edit-search-user-text")).sendKeys("SGA TRAINING" +date);
		Thread.sleep(1000);
		...
		boolean var8=  driver.findElement(By.xpath("//nav[@class='pcoded-navbar menu-light navbar-collapsed']")).isDisplayed();
		...
		driver.findElement(By.xpath("(//input[@type='search'])[1]")).sendKeys("SGA TRAINING" +date);
		Thread.sleep(3000);
		...
		driver.findElement(By.id("edit-name-0-value")).click();
		Thread.sleep(5000);
		
		driver.findElement(By.id("edit-name-0-value")).clear();
		Thread.sleep(5000);

		driver.findElement(By.id("edit-name-0-value")).sendKeys("T/F");
		Thread.sleep(10000);

		driver.switchTo().parentFrame();
		Thread.sleep(10000);
		
		WebElement iframe34 = driver.findElement(By.id("iFrameResizer0"));
		driver.switchTo().frame(iframe34);
		WebElement web34=driver.findElement(By.xpath("//html[@dir='ltr']"));
		web34.click();
		Thread.sleep(2000);
	
		driver.findElement(By.xpath("//input[@id='edit-submit']")).sendKeys(Keys.ENTER);
		Thread.sleep(2000);
		System.out.println("True or False Question Created");

		driver.switchTo().parentFrame();
		Thread.sleep(2000);
		
		driver.findElement(By.xpath("//input[@name='enable_check_button']")).click();
		Thread.sleep(4000);
