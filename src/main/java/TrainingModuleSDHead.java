...
public class TrainingModuleSDHead {	
	...
	public void IsonLogin() throws InterruptedException
	{
		...
		driver.findElement(By.id("edit-label-0-value")).sendKeys("SDHead TRAINING" +date);
		...
		driver.findElement(By.id("edit-name-0-value")).sendKeys("SDHead Assessment" +date1);
		Thread.sleep(7000);
		...
		driver.findElement(By.id("edit-search-user-text")).sendKeys("SDHead TRAINING" +date);
		Thread.sleep(1000);
		...
		driver.findElement(By.name("username")).sendKeys(config.getTraineeUserName()); 

		//driver.findElement(By.name("username")).sendKeys("ISCH03110"); //Bijoy

		//driver.findElement(By.name("username")).sendKeys("ISBL01905"); //Pradeepa
		...
		driver.findElement(By.xpath("(//input[@type='search'])[1]")).sendKeys("SDHead TRAINING" +date);
		Thread.sleep(5000);
