...
public class lmsQuickAccessDashboardSDHead {
	...
	public void testlmsQuickAccessDashboard() throws Exception {
		...
		driver.findElement(By.xpath("(//a[@title='Message'])[1]")).click();
		System.out.println("Clicked on Message Icon to view Notification");
		Thread.sleep(10000);
