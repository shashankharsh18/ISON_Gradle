...
public class AssessmentModuleTrainer{
	...
	public void testAssessment() throws Exception {
		...
		boolean var7=  driver.findElement(By.cssSelector("button.wr-btn.grey-bg.col-xs-12.col-md-12.col-lg-12.uppercase.font-extra-large.margin-bottom-double.submit-button-sso")).isDisplayed();
